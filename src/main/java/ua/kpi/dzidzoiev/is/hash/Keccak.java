...
import ua.kpi.dzidzoiev.is.util.LittleEndian;
import ua.kpi.dzidzoiev.is.util.Parameters;

import java.util.Arrays;

import static ua.kpi.dzidzoiev.is.util.Hex.toHexString;
...
final class Keccak extends AbstractDigest
{
    ...
    public static void main(String[] args)
    {
        ...
        Digest sha3 = new Keccak(48);
        for (String s : testStrings)
            System.out.println("0x" + toHexString(sha3.digest(s.getBytes())) + " <== \"" + s + "\"");
    }
